...
describe('difference', () => {
  ...
  test('parameters not array', () => {
    ...
    // Non-array in "values" is ignored by baseFlatten with isArrayLikeObject -> returns original array
    expect(difference(['a', 'b', 'c'], 'b')).toEqual(['a', 'b', 'c']);
  });
});
